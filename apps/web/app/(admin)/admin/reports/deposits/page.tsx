import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Deposits Report | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Reports",
  "title": "Deposits Report",
  "description": "Track deposit balances, refund requests, exit deductions, adjustments, and approvals.",
  "apiRoute": "/api/v1/reports/deposits",
  "primaryAction": {
    "href": "/admin/reports",
    "label": "Export Report"
  },
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage deposits report while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
