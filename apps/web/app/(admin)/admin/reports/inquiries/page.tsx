import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Inquiries Report | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Reports",
  "title": "Inquiries Report",
  "description": "Analyze lead source, response time, conversion, lost reasons, and stale inquiries.",
  "apiRoute": "/api/v1/reports/inquiries",
  "primaryAction": {
    "href": "/admin/reports",
    "label": "Export Report"
  },
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage inquiries report while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Inquiries Report summary",
