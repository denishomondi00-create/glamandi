...
export default async function Page() {
  ...
  try { data = await serverApi.get<Record<string, unknown>>("/reports/penalties", { cache: "no-store" }); } catch {}
      ...
      <section className="relative overflow-hidden rounded-[2rem] border border-[#C5F0F8]/80 bg-white p-6 shadow-xl shadow-[#145F6B]/5 lg:p-8">
        ...
        <div className="relative flex flex-wrap items-start justify-between gap-4">
          <div><Badge>Admin / Reports</Badge>
            <h1 className="mt-4 text-4xl font-black tracking-tight text-[#145F6B]">Penalties</h1>
