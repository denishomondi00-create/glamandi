import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Collections Report | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Reports",
  "title": "Collections Report",
  "description": "Analyze monthly billing, collections, balances, channel split, and collection rate.",
  "apiRoute": "/api/v1/reports/collections",
  "primaryAction": {
    "href": "/admin/reports",
    "label": "Export Report"
  },
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage collections report while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Collections Report summary",
