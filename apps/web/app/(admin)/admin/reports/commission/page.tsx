import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Commission Report | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Reports",
  "title": "Commission Report",
  "description": "Calculate Glamandi commission from collected money based on active commission rules.",
  "apiRoute": "/api/v1/reports/commission",
  "primaryAction": {
    "href": "/admin/reports",
    "label": "Export Report"
  },
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage commission report while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Commission Report summary",
