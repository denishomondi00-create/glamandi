import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Occupancy Report | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Reports",
  "title": "Occupancy Report",
  "description": "Track occupied, vacant, reserved, maintenance, and locked units by property.",
  "apiRoute": "/api/v1/reports/occupancy",
  "primaryAction": {
    "href": "/admin/reports",
    "label": "Export Report"
  },
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage occupancy report while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Occupancy Report summary",
