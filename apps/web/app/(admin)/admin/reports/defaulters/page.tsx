import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Defaulters Report | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Reports",
  "title": "Defaulters Report",
  "description": "List late tenants, outstanding balances, penalty bands, and communication exceptions.",
  "apiRoute": "/api/v1/reports/defaulters",
  "primaryAction": {
    "href": "/admin/reports",
    "label": "Export Report"
  },
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage defaulters report while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Defaulters Report summary",
