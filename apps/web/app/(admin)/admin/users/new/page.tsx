import type { Metadata } from "next";
  ...
  "eyebrow": "Admin / Users",
  "title": "New User",
  "description": "Invite a user, assign role, set portal access, and prepare secure onboarding.",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage new user while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "formFields": [
    {
      ...
      "placeholder": "Enter new user reference"
    },
    {
      "label": "Status",
      "type": "select",
