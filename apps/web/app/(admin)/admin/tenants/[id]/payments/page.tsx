import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Tenant Payments | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Tenants",
  "title": "Tenant Payments",
  "description": "View all payments, allocations, channels, reversals, and reconciliation status for this tenant.",
  "apiRoute": "/api/v1/tenants/:id/payments",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage tenant payments while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "formTitle": "Tenant Payments form",
  "formFields": [
    {
      "label": "Name / Reference",
      "placeholder": "Enter tenant payments reference"
    },
    {
      "label": "Status",
      "type": "select",
