import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Tenant Repairs | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Tenants",
  "title": "Tenant Repairs",
  "description": "Review repair requests submitted by the tenant and their completion status.",
  "apiRoute": "/api/v1/tenants/:id/repairs",
  "primaryAction": {
    "href": "/admin/tenants/[id]/repairs/new",
    "label": "Create New"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage tenant repairs while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
