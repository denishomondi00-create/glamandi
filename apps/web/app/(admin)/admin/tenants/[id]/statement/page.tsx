import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Tenant Statement | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Tenants",
  "title": "Tenant Statement",
  "description": "Generate and view the tenant statement across charges, payments, allocations, and balances.",
  "apiRoute": "/api/v1/tenants/:id/statement",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage tenant statement while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Tenant Statement records",
