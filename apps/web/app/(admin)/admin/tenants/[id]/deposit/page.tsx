import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Tenant Deposit | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Tenants",
  "title": "Tenant Deposit",
  "description": "Track deposit ledger, refund eligibility, exit deductions, review status, and refund request history.",
  "apiRoute": "/api/v1/tenants/:id/deposit",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage tenant deposit while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
