import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Tenant Charges | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Tenants",
  "title": "Tenant Charges",
  "description": "See rent, utility, deposit, move-in, penalty, and adjustment charges for this tenant.",
  "apiRoute": "/api/v1/tenants/:id/charges",
  "primaryAction": {
    "href": "/admin/tenants/[id]/charges/new",
    "label": "Create New"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage tenant charges while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
