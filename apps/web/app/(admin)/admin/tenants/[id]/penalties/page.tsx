import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Tenant Penalties | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Tenants",
  "title": "Tenant Penalties",
  "description": "View late payment penalties, waiver reasons, manual applications, and communication exceptions.",
  "apiRoute": "/api/v1/tenants/:id/penalties",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage tenant penalties while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Tenant Penalties records",
