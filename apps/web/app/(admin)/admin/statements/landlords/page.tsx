import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Landlord Statements | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Statements",
  "title": "Landlord Statements",
  "description": "Generate monthly landlord statements including commission, repairs, withdrawals, and net payout.",
  "apiRoute": "/api/v1/statements/landlords",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      "title": "Statements workflow",
      "description": "Use this page to manage landlord statements while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Landlord Statements records",
