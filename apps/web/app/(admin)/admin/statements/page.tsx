import type { Metadata } from "next";
  ...
  "title": "Statements",
  "description": "Generate and view landlord and tenant statements with PDFs and email delivery.",
  "apiRoute": "/api/v1/statements",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage statements while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
