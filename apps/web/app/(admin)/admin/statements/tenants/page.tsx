import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Tenant Statements | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Statements",
  "title": "Tenant Statements",
  "description": "Generate tenant statements across charges, payments, receipts, penalties, and balances.",
  "apiRoute": "/api/v1/statements/tenants/generate",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage tenant statements while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Tenant Statements records",
