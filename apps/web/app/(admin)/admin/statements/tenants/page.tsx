...
export const metadata: Metadata = { title: "Tenants Statements | Glamandi Control Center" };
export default function Page() {
  return (
    <AdminListPage
      eyebrow="Admin / Statements / Tenants" title="Tenants Statements"
      description="Monthly statements for tenants — rent collections, commission, deductions, and net payout."
      apiPath="/statements"
      columns={[
