import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Inquiry Detail | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Inquiries",
  "title": "Inquiry Detail",
  "description": "Review inquiry source, contact details, interested unit, assignment, follow-up, and conversion status.",
  "apiRoute": "/api/v1/inquiries/:id",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      "title": "Inquiries workflow",
      "description": "Use this page to manage inquiry detail while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
