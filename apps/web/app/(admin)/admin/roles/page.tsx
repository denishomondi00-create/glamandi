import type { Metadata } from "next";
  ...
  "eyebrow": "Admin / Roles",
  "title": "Roles",
  "description": "Manage Admin, Staff, Tenant, Landlord, and scoped custom permissions.",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage roles while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
