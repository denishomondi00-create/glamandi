import type { Metadata } from "next";
  ...
  "title": "New Property",
  "description": "Create a property with canonical location, public address label, landlord assignment, and website controls.",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage new property while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "formTitle": "New Property form",
  "formFields": [
    {
      "label": "Name / Reference",
      "placeholder": "Enter new property reference"
    },
    {
      "label": "Status",
      "type": "select",
