import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Property Units | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Properties",
  "title": "Property Units",
  "description": "View and manage all units connected to this property, including occupancy and listing status.",
  "apiRoute": "/api/v1/properties/:id/units",
  "primaryAction": {
    "href": "/admin/properties/[id]/units/new",
    "label": "Create New"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage property units while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
