import type { Metadata } from "next";
  ...
  "title": "Payouts",
  "description": "Manage landlord payouts, proof uploads, reversals, paid status, and reconciliation notes.",
  "apiRoute": "/api/v1/payouts",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage payouts while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
