import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Daraja STK Payment | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Payments",
  "title": "Daraja STK Payment",
  "description": "Initiate M-Pesa STK push and process Safaricom callback through webhook truth.",
  "apiRoute": "/api/v1/payments/initialize/daraja-stk",
  "primaryAction": {
    "href": "/admin/payments/daraja-stk",
    "label": "Save Draft"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage daraja stk payment while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Daraja STK Payment records",
  ...
  "formTitle": "Daraja STK Payment form",
  "formFields": [
    {
      "label": "Tenant",
    ...
    },
    {
      ...
      "placeholder": "M-Pesa / KCB / checkout reference"
    },
    {
    ...
    },
    {
      "label": "Posting note",
      "type": "textarea",
      "placeholder": "Record verification or offline draft note"
    }
  ],
