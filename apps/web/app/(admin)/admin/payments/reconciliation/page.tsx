import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Payment Reconciliation | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Payments",
  "title": "Payment Reconciliation",
  "description": "Review pending intents, duplicate references, failed callbacks, and manual reconciliation cases.",
  "apiRoute": "/api/v1/payments/reconciliation",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage payment reconciliation while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Payment Reconciliation records",
  ...
  "formTitle": "Payment Reconciliation form",
  "formFields": [
    {
      "label": "Name / Reference",
      "placeholder": "Enter payment reconciliation reference"
    },
    {
      "label": "Status",
      "type": "select",
