import type { Metadata } from "next";
  ...
  "title": "Cash Payment",
  "description": "Record cash payment draft or server-confirmed posting with cashier accountability.",
  "apiRoute": "/api/v1/payments/manual/cash",
  "primaryAction": {
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage cash payment while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
