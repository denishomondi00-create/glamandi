import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Manual KCB Payment | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Payments",
  "title": "Manual KCB Payment",
  "description": "Record KCB bank payment with bank reference, tenant, amount, and optional proof.",
  "apiRoute": "/api/v1/payments/manual/kcb",
  "primaryAction": {
    "href": "/admin/payments/manual-kcb",
    "label": "Save Draft"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage manual kcb payment while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Manual KCB Payment records",
  ...
  "formTitle": "Manual KCB Payment form",
  "formFields": [
    {
      "label": "Tenant",
