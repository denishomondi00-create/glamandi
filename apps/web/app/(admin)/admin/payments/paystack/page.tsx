import type { Metadata } from "next";
  ...
  "description": "Initialize hosted checkout, verify transaction server-side, and post exactly once.",
  "apiRoute": "/api/v1/payments/initialize/paystack",
  "primaryAction": {
    "href": "/admin/payments/paystack",
    "label": "Save Draft"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage paystack payment while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Paystack Payment records",
  ...
  "formTitle": "Paystack Payment form",
  "formFields": [
    {
      "label": "Tenant",
