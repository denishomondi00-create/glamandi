import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Manual M-Pesa Payment | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Payments",
  "title": "Manual M-Pesa Payment",
  "description": "Record a manual M-Pesa payment draft or online posting with reference validation.",
  "apiRoute": "/api/v1/payments/manual/mpesa",
  "primaryAction": {
    "href": "/admin/payments/manual-mpesa",
    "label": "Save Draft"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage manual m-pesa payment while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Manual M-Pesa Payment records",
  ...
  "formTitle": "Manual M-Pesa Payment form",
  "formFields": [
    {
      "label": "Tenant",
