import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Website SEO | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Website",
  "title": "Website SEO",
  "description": "Manage title tags, meta descriptions, open graph data, slugs, and search visibility.",
  "apiRoute": "/api/v1/website/seo",
  "primaryAction": {
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage website seo while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "formTitle": "Website SEO form",
  "formFields": [
    {
      "label": "Name / Reference",
      "placeholder": "Enter website seo reference"
    },
    {
      "label": "Status",
      "type": "select",
