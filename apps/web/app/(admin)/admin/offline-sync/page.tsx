import type { Metadata } from "next";
  ...
  "title": "Offline Sync",
  "description": "Monitor devices, sync batches, pending outbox items, accepted mutations, and conflicts.",
  "apiRoute": "/api/v1/sync/batches",
  "primaryAction": {
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage offline sync while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
