import type { Metadata } from "next";
  ...
  "description": "Review communication exceptions that prevent or justify penalty changes.",
  "apiRoute": "/api/v1/penalties/communication-exceptions",
  "primaryAction": {
    "href": "/admin/penalties/exceptions/new",
    "label": "Create New"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage penalty exceptions while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
