import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Transfer Unit | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Tenancies",
  "title": "Transfer Unit",
  "description": "Move a tenant to another unit while preserving historical location snapshots and audit trail.",
  "apiRoute": "/api/v1/tenancies/:id/transfer-unit",
  "primaryAction": {
    "href": "/admin/tenancies/[id]/transfer",
    "label": "Save Draft"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage transfer unit while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "formTitle": "Transfer Unit form",
  "formFields": [
    {
      "label": "Name / Reference",
      "placeholder": "Enter transfer unit reference"
    },
    {
      "label": "Status",
      "type": "select",
