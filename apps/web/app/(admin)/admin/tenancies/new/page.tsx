import type { Metadata } from "next";
  ...
  "title": "New Tenancy",
  "description": "Create tenancy, snapshot location, generate move-in billing, assign unit, and activate tenant account.",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage new tenancy while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "formTitle": "New Tenancy form",
  "formFields": [
    {
      "label": "Name / Reference",
      "placeholder": "Enter new tenancy reference"
    },
    {
      "label": "Status",
      "type": "select",
