import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Deposit Refund Requests | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Deposits",
  "title": "Deposit Refund Requests",
  "description": "Review tenant refund requests, notice compliance, approval status, and payout readiness.",
  "apiRoute": "/api/v1/deposits/:id/refund-request",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage deposit refund requests while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Deposit Refund Requests records",
