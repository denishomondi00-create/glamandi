import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Deposit Exit Reviews | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Deposits",
  "title": "Deposit Exit Reviews",
  "description": "Manage exit inspection, repair deductions, final balances, and refund approval workflow.",
  "apiRoute": "/api/v1/deposits/:id/exit-deduction",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage deposit exit reviews while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Deposit Exit Reviews records",
