import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Business Rules | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Settings",
  "title": "Business Rules",
  "description": "Configure rent due day, move-in billing, notice rules, and operational defaults.",
  "apiRoute": "/api/v1/settings/business-rules",
  "primaryAction": {
    "href": "/admin/settings/business-rules",
    "label": "Save Draft"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage business rules while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "formTitle": "Business Rules form",
  "formFields": [
    {
      "label": "Name / Reference",
      "placeholder": "Enter business rules reference"
    },
    {
      "label": "Status",
      "type": "select",
