...
export const metadata: Metadata = { title: "Payment Methods | Settings | Glamandi Control Center" };
export default function Page() {
  return (
    <AdminFormPage
      eyebrow="Admin / Settings"
      title="Payment Methods"
      description="Configure Payment Methods. Changes take effect immediately and are logged to the audit trail."
      apiPath="/settings/payment-methods"
      method="PATCH"
      fields={[
