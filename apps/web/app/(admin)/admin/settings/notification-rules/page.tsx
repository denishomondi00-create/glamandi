import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Notification Rules | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Settings",
  "title": "Notification Rules",
  "description": "Configure rent reminders, receipts, inquiry follow-up, repair reminders, and statement emails.",
  "apiRoute": "/api/v1/settings/notification-rules",
  "primaryAction": {
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage notification rules while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "formTitle": "Notification Rules form",
  "formFields": [
    {
      "label": "Name / Reference",
      "placeholder": "Enter notification rules reference"
    },
    {
      "label": "Status",
      "type": "select",
