import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Penalty Rules | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Settings",
  "title": "Penalty Rules",
  "description": "Configure late rent bands, waiver requirements, manual imposition rules, and exception logic.",
  "apiRoute": "/api/v1/settings/penalty-rules",
  "primaryAction": {
    "href": "/admin/settings/penalty-rules",
    "label": "Save Draft"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage penalty rules while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "formTitle": "Penalty Rules form",
  "formFields": [
    {
      "label": "Name / Reference",
      "placeholder": "Enter penalty rules reference"
    },
    {
      "label": "Status",
      "type": "select",
