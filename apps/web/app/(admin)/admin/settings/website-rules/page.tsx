...
export const metadata: Metadata = { title: "Website Rules | Settings | Glamandi Control Center" };
export default function Page() {
  return (
    <AdminFormPage
      eyebrow="Admin / Settings"
      title="Website Rules"
      description="Configure Website Rules. Changes take effect immediately and are logged to the audit trail."
      apiPath="/settings/website-rules"
      method="PATCH"
      fields={[
