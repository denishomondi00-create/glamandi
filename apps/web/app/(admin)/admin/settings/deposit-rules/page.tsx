import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Deposit Rules | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Settings",
  "title": "Deposit Rules",
  "description": "Configure deposit handling, refund eligibility, notice rules, and exit deduction workflow.",
  "apiRoute": "/api/v1/settings/deposit-rules",
  "primaryAction": {
    "href": "/admin/settings/deposit-rules",
    "label": "Save Draft"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage deposit rules while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "formTitle": "Deposit Rules form",
  "formFields": [
    {
      "label": "Name / Reference",
      "placeholder": "Enter deposit rules reference"
    },
    {
      "label": "Status",
      "type": "select",
