...
export const metadata: Metadata = { title: "Offline Rules | Settings | Glamandi Control Center" };
export default function Page() {
  return (
    <AdminFormPage
      eyebrow="Admin / Settings"
      title="Offline Rules"
      description="Configure Offline Rules. Changes take effect immediately and are logged to the audit trail."
      apiPath="/settings/offline-rules"
      method="PATCH"
      fields={[
