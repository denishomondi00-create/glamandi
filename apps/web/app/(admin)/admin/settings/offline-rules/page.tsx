import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Offline Rules | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Settings",
  "title": "Offline Rules",
  "description": "Configure cache duration, allowed offline actions, device registration, and mutation age limits.",
  "apiRoute": "/api/v1/settings/offline-rules",
  "primaryAction": {
    "href": "/admin/settings/offline-rules",
    "label": "Save Draft"
  },
  "secondaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage offline rules while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "formTitle": "Offline Rules form",
  "formFields": [
    {
      "label": "Name / Reference",
      "placeholder": "Enter offline rules reference"
    },
    {
      "label": "Status",
      "type": "select",
