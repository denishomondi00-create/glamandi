import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Receipt Detail | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Receipts",
  "title": "Receipt Detail",
  "description": "Inspect receipt data, allocations, payment source, PDF status, email log, and audit trail.",
  "apiRoute": "/api/v1/receipts/:id",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage receipt detail while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
