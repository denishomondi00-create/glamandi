import type { Metadata } from "next";
  ...
  "title": "Receipts",
  "description": "View official receipts, PDF status, email delivery, regeneration, and tenant downloads.",
  "apiRoute": "/api/v1/receipts",
  "primaryAction": {
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage receipts while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
