import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Unit Profile | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Units",
  "title": "Unit Profile",
  "description": "View unit status, current tenant, charges, repairs, access details, and availability history.",
  "apiRoute": "/api/v1/units/:id",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage unit profile while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
