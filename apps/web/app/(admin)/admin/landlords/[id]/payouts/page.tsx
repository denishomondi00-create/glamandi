import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Landlord Payouts | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Landlords",
  "title": "Landlord Payouts",
  "description": "Track payout history, proof uploads, reversals, and payout status.",
  "apiRoute": "/api/v1/landlords/:id/payouts",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage landlord payouts while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Landlord Payouts records",
