import type { Metadata } from "next";
        ...
        export const metadata: Metadata = { title: "Landlord Deductions | Glamandi Control Center" };

        const page = {
  "eyebrow": "Admin / Landlords",
  "title": "Landlord Deductions",
  "description": "Review approved repair deductions, pending approvals, and statement impact for this landlord.",
  "apiRoute": "/api/v1/landlords/:id/deductions",
  "primaryAction": {
    "href": "/admin",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage landlord deductions while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
  ...
  "table": {
    "title": "Landlord Deductions records",
