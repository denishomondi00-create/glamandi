import type { Metadata } from "next";
  ...
  "title": "Landlords",
  "description": "Manage landlord profiles, owned properties, statements, payouts, deductions, documents, and portal access.",
  ...
  "panels": [
    {
      ...
      "description": "Use this page to manage landlords while keeping the Control Center tied to the API and audit trail.",
      "items": [
        "Server-backed data",
        "Role-based access",
